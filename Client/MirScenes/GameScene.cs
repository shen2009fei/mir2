    ...
    public sealed class GameScene : MirScene
    {
                ...
                case Spell.CounterAttack:
                    if ((CMain.Time < magic.CastTime + magic.Delay))
                    {
                        if (CMain.Time >= OutputDelay)
                        {
                            ...
                            GameScene.Scene.OutputMessage(string.Format(Resources.ResourceCommon.YouCannotCastForAnotherSeconds, magic.Spell.ToString(), ((magic.CastTime + magic.Delay) - CMain.Time - 1) / 1000 + 1));
                        }
                ...
                for (int i = MapControl.Objects.Count - 1; i >= 0; i--)
                {
                    ...
                    switch (p.Type)
                    {
                        ...
                        case DamageType.Miss:
                            obj.Damages.Add(new Damage(Resources.ResourceCommon.Miss, 1200, obj.Race == ObjectType.Player ? Color.LightCoral : Color.LightGray, 50));
                            break;
                        case DamageType.Critical:
                            obj.Damages.Add(new Damage(Resources.ResourceCommon.Crit, 1000, obj.Race == ObjectType.Player ? Color.DarkRed : Color.DarkRed, 50) { Offset = 15 });
                            break;
                    }
                }
            }
        ...
        private void GuildMemberChange(S.GuildMemberChange p)
        {
            switch (p.Status)
            {
                case 0: // logged of
                    ...
                    break;
                case 1: // logged on
                    ChatDialog.ReceiveChat(String.Format(Resources.ResourceCommon.LoggedOn , p.Name), ChatType.Guild);
                    GuildDialog.MemberStatusChange(p.Name, true);
                    break;
                case 2://new member
                    ChatDialog.ReceiveChat(String.Format(Resources.ResourceCommon.JoinedGuild , p.Name), ChatType.Guild);
                    GuildDialog.MemberCount++;
                    GuildDialog.MembersChanged = true;
                    break;
                case 3://kicked member
                    ChatDialog.ReceiveChat(String.Format(Resources.ResourceCommon.GotRemovedFromTheGuild, p.Name), ChatType.Guild);
                    GuildDialog.MembersChanged = true;
                    break;
                case 4://member left
                    ChatDialog.ReceiveChat(String.Format(Resources.ResourceCommon.LeftTheGuild, p.Name), ChatType.Guild);
                    GuildDialog.MembersChanged = true;
                    break;
        ...
        private void TradeCancel(S.TradeCancel p)
        {
            ...
            else
            {
                ...
                MirMessageBox messageBox = new MirMessageBox(Resources.ResourceCommon.DealCancelledToDealCorrectlyYouMustFaceTheOtherParty, MirMessageBoxButtons.OK);
                messageBox.Show();
            }
        }
        ...
        private void Awakening(S.Awakening p)
        {
            ...
            {
                case -4:
                    messageBox = new MirMessageBox(Resources.ResourceNPCDialog.YouHaveNotSuppliedEnoughMaterials, MirMessageBoxButtons.OK);
                ...
                case -3:
                    ...
                    break;
                case -2:
                    messageBox = new MirMessageBox(Resources.ResourceNPCDialog.AwakeningAlreadyAtMaximumLevel, MirMessageBoxButtons.OK);
                    MapControl.AwakeningAction = false;
                    break;
                case -1:
                    messageBox = new MirMessageBox(Resources.ResourceNPCDialog.CannotAwakenThisItem, MirMessageBoxButtons.OK);
                    MapControl.AwakeningAction = false;
                    break;
                case 0:
        ...
        private void NewIntelligentCreature(S.NewIntelligentCreature p)
        {
            ...
            MirInputBox inputBox = new MirInputBox(Resources.ResourceCommon.PleaseGiveYourCreatureAName);
        ...
        public MirControl NameInfoLabel(UserItem item, bool inspect = false, bool hideDura = false)
        {
            ...
            switch (HoverItem.Info.Type)
            {
                ...
                case ItemType.Weapon:
                    baseText = Resources.ResourceItemType.ItemTypeWeapon;
                    break;
                case ItemType.Armour:
                    baseText = Resources.ResourceItemType.ItemTypeArmour;
                    break;
                case ItemType.Helmet:
                    baseText = Resources.ResourceItemType.ItemTypeHelmet;
                    break;
                case ItemType.Necklace:
                    baseText = Resources.ResourceItemType.ItemTypeNecklace;
                    break;
                case ItemType.Bracelet:
                    baseText = Resources.ResourceItemType.ItemTypeBracelet;
                    break;
                case ItemType.Ring:
                    baseText = Resources.ResourceItemType.ItemTypeRing;
                    break;
                case ItemType.Amulet:
                    baseText = Resources.ResourceItemType.ItemTypeAmulet;
                    break;
                case ItemType.Belt:
                    baseText = Resources.ResourceItemType.ItemTypeBelt;
                    break;
                case ItemType.Boots:
                    baseText = Resources.ResourceItemType.ItemTypeBoots;
                    break;
                case ItemType.Stone:
                    baseText = Resources.ResourceItemType.ItemTypeStone;
                    break;
                case ItemType.Torch:
                    baseText = Resources.ResourceItemType.ItemTypeTorch;
                    break;
                case ItemType.Potion:
                    baseText = Resources.ResourceItemType.ItemTypePotion;
                    break;
                case ItemType.Ore:
                    baseText = Resources.ResourceItemType.ItemTypeOre;
                    break;
                case ItemType.Meat:
                    baseText = Resources.ResourceItemType.ItemTypeMeat;
                    break;
                case ItemType.CraftingMaterial:
                    baseText = Resources.ResourceItemType.ItemTypeCraftingMaterial;
                    break;
                case ItemType.Scroll:
                    baseText = Resources.ResourceItemType.ItemTypeScroll;
                    break;
                case ItemType.Gem:
                    baseText = Resources.ResourceItemType.ItemTypeGem;
                    break;
                case ItemType.Mount:
                    baseText = Resources.ResourceItemType.ItemTypeMount;
                    break;
                case ItemType.Book:
                    baseText = Resources.ResourceItemType.ItemTypeBook;
                    break;
                case ItemType.Script:
                    baseText = Resources.ResourceItemType.ItemTypeScript;
                    break;
                case ItemType.Reins:
                    baseText = Resources.ResourceItemType.ItemTypeReins;
                    break;
                case ItemType.Bells:
                    baseText = Resources.ResourceItemType.ItemTypeBells;
                    break;
                case ItemType.Saddle:
                    baseText = Resources.ResourceItemType.ItemTypeSaddle;
                    break;
                case ItemType.Ribbon:
                    baseText = Resources.ResourceItemType.ItemTypeRibbon;
                    break;
                case ItemType.Mask:
                    baseText = Resources.ResourceItemType.ItemTypeMask;
                    break;
                case ItemType.Food:
                    baseText = Resources.ResourceItemType.ItemTypeFood;
                    break;
                case ItemType.Hook:
                    baseText = Resources.ResourceItemType.ItemTypeHook;
                    break;
                case ItemType.Float:
                    baseText = Resources.ResourceItemType.ItemTypeFloat;
                    break;
                case ItemType.Bait:
                    baseText = Resources.ResourceItemType.ItemTypeBait;
                    break;
                case ItemType.Finder:
                    baseText = Resources.ResourceItemType.ItemTypeFinder;
                    break;
                case ItemType.Reel:
                    baseText = Resources.ResourceItemType.ItemTypeReel;
                    break;
                case ItemType.Fish:
                    baseText = Resources.ResourceItemType.ItemTypeFish;
                    break;
                case ItemType.Quest:
                    baseText = Resources.ResourceItemType.ItemTypeQuest;
                    break;
                case ItemType.Awakening:
                    baseText = Resources.ResourceItemType.ItemTypeAwakening;
                    break;
                case ItemType.Pets:
                    baseText = Resources.ResourceItemType.ItemTypePets;
                    break;
                case ItemType.Transform:
                    baseText = Resources.ResourceItemType.ItemTypeTransform;
                    break;
                case ItemType.Deco:
                    baseText = Resources.ResourceItemType.ItemTypeDeco;
                    break;
            }
        ...
        public MirControl AttackInfoLabel(UserItem item, bool Inspect = false, bool hideAdded = false)
        {
            ...
            if ((minValue > 0 || maxValue > 0 || addValue > 0) && (realItem.Type != ItemType.Gem))
            {
                ...
                MirLabel CRITICALDAMAGELabel = new MirLabel
                {
                    ...
                    Text = string.Format(addValue > 0 ? "{0}: + {1} (+{2})" : "{0}: + {1}",Resources.ResourceItemInfo.CriticalDamage, minValue + addValue, addValue)
                };
            ...
            if ((minValue > 0 || maxValue > 0 || addValue > 0) && (realItem.Type != ItemType.Gem))
            {
                ...
                MirLabel ReflectLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(Resources.ResourceItemInfo.ReflectChance, minValue)
                };
        ...
        public MirControl WeightInfoLabel(UserItem item, bool Inspect = false)
        {
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                MirLabel HANDWEIGHTLabel = new MirLabel
                {
                    ...
                    Text = string.Format(addValue > 0 ? "{0} + {1} (+{2})" : "{0} + {1}",Resources.ResourceCharStat2.HandWeight,  minValue + addValue, addValue)
                };
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                MirLabel WEARWEIGHTLabel = new MirLabel
                {
                    ...
                    Text = string.Format(addValue > 0 ? "{0} + {1} (+{2})" : "{0} + {1}", Resources.ResourceCharStat2.ArmourWeight, minValue + addValue, addValue)
                };
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                MirLabel BAGWEIGHTLabel = new MirLabel
                {
                    ...
                    Text = string.Format(addValue > 0 ? Resources.ResourceCharStat2.BagWeight + " + {0} (+{1})" : Resources.ResourceCharStat2.BagWeight + " + {0}", minValue + addValue, addValue)
                };
        ...
        public MirControl SocketInfoLabel(UserItem item, bool Inspect = false)
        {
            ...
            for (int i = 0; i < item.Slots.Length; i++)
            {
                ...
                MirLabel SOCKETLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.SocketDesc, item.Slots[i] == null ? GameLanguage.SocketEmpty : item.Slots[i].FriendlyName)
                };
        ...
        public MirControl BindInfoLabel(UserItem item, bool Inspect = false, bool hideAdded = false)
        {
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontUpgrade))
            {
                ...
                MirLabel DONT_UPGRADELabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(Resources.ResourceItemInfo.CantUpgrade)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontSell))
            {
                ...
                MirLabel DONT_SELLLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.CannotSell)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontStore))
            {
                ...
                MirLabel DONT_STORELabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(Resources.ResourceItemInfo.CantStore)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontRepair))
            {
                ...
                MirLabel DONT_REPAIRLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(Resources.ResourceItemInfo.CantRepair)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.NoSRepair))
            {
                ...
                MirLabel DONT_REPAIRLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(Resources.ResourceItemInfo.CantSpecialRepair)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.BreakOnDeath))
            {
                ...
                MirLabel DONT_REPAIRLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(Resources.ResourceItemInfo.BreaksOnDeath)
                };
            ...
            if ((HoverItem.Info.Bind.HasFlag(BindMode.BindOnEquip)) & HoverItem.SoulBoundId == -1)
            {
                ...
                MirLabel BOELabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(Resources.ResourceItemInfo.SoulbindsOnEquip)
                };
            ...
            else if (HoverItem.SoulBoundId != -1)
            {
                ...
                MirLabel BOELabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = Resources.ResourceItemInfo.SoulboundTo + GetUserName((uint)HoverItem.SoulBoundId)
                };
            ...
            if (HoverItem.Info.Type == ItemType.Gem)
            {
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Paralize))
                {
                    MirLabel GemWeapon = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = "-" + Resources.ResourceItemInfo.Weapon
                    };
            ...
            //        OutLine = true,
            //        Parent = ItemLabel,
            //        Text = string.Format(Resources.ResourceItemInfo.CantAwaken)
            //    };
            ...
            else if (HoverItem.RentalInformation?.RentalLocked == true && HoverItem.RentalInformation.ExpiryDate > DateTime.Now)
            {
                ...
                var RentalLockLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = remainingTime > 0 ? string.Format("{0}: {1}", Resources.ResourceItemInfo.RentalLockExpiresIn, Functions.PrintTimeSpanFromSeconds(remainingTime)) : "Rental lock expired"
                };
                    ...
                    (!MapObject.TargetObject.Name.EndsWith(")") && MapObject.TargetObject is MonsterObject))
                {
                    ...
                    if (User.Class == MirClass.Archer && User.HasClassWeapon && !User.RidingMount && !User.Fishing)//ArcherTest - non aggressive targets (player / pets)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                OutputDelay = CMain.Time + 1000;
                                GameScene.Scene.OutputMessage(Resources.ResourceCommon.TargetIsTooFar);
                            }
                        }
                        //  return;
                    }
