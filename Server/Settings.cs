        ...
        public static void LoadRandomItemStats()
        {
            ...
            while (reader.ReadByte("Item" + i.ToString(),"MaxDuraChance",255) != 255)
            {
                stat = new RandomItemStat
                {
                    ...
                    SlotChance = reader.ReadByte("Item" + i.ToString(), "SlotChance", 0),
                    SlotStatChance = reader.ReadByte("Item" + i.ToString(), "SlotStatChance", 0),
                    SlotMaxStat = reader.ReadByte("Item" + i.ToString(), "SlotMaxStat", 0)
                };
